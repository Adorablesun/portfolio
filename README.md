...
Reserved expansion pages are available at `resume/`, `showreel/`, and `lab/`. A compact Explore menu connects them without crowding the primary navigation. Each route has its own structured placeholder for the future résumé PDF, showreel player, or collection of creative experiments.

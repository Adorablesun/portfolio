...
The shared navigation stays at the top of every page as a liquid-glass surface with refracted color, moving caustics, bright inner edges, and a pointer-responsive highlight. Its wordmark, links, numbered droplets, and CTA share a consistent control rail, while a live page-progress signal runs along the lower edge. Active-page, hover, mobile, dark-theme, and reduced-motion states are included.
